...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto create(Long ownerId, ItemDto dto) {
        ...
        Item item = itemMapper.toItemWithRequest(dto, ownerId);
    ...
    public ItemDto getItemForUser(Long itemId, Long userId) {
        ...
        // ВСЕГДА возвращаем полные данные с бронированиями и комментариями
    ...
    public CommentDto addComment(Long itemId, CommentDto commentDto, Long userId) {
        ...
        // ИСПРАВЛЕНИЕ: более гибкая проверка бронирований
        List<Booking> userBookings = bookingRepository.findByBookerIdAndItemIdAndEndBefore(userId, itemId, LocalDateTime.now());

        // Разрешить комментарии если есть ЛЮБОЕ завершенное бронирование (не только APPROVED)
        ...
        return items.stream()
                .map(item -> {
                    ...
                    itemDto.setNextBooking(nextBooking != null ?
                            new BookingShortDto(nextBooking.getId(), nextBooking.getBookerId(),
