...
class ItemDtoJsonTest {
    ...
    @Test
    void shouldSerializeItemDtoWithRequestId() throws Exception {
    ...
    @Test
    void shouldDeserializeItemDtoWithRequestId() throws Exception {
    ...
    void shouldHandleNullRequestId() throws Exception {
        String content = "{\"id\":1,\"name\":\"Drill\",\"description\":\"Powerful electric drill\",\"available\":true}";
